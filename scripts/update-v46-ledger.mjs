...
const frozenFeatures = candidate => ({
  ...
  lateConfirmationRisk: candidate.lateConfirmationRisk ?? null,
  priceResponseWeak: candidate.priceResponseWeak ?? null,
  exhaustionRisk: candidate.exhaustionRisk ?? null,
  comfortState: candidate.comfortState ?? null,
  comfortFlags: candidate.comfortFlags ?? [],
...
const candidateFeatures = candidate => ({
  ...
  lastLateConfirmationRisk: candidate.lateConfirmationRisk ?? null,
  lastPriceResponseWeak: candidate.priceResponseWeak ?? null,
  lastExhaustionRisk: candidate.exhaustionRisk ?? null,
  lastComfortState: candidate.comfortState ?? null,
  lastComfortFlags: candidate.comfortFlags ?? [],
